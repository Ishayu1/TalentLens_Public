...
def assess_candidate_packet_with_grok(
    ...
    try:
        ...
        prompt = (
            ...
            "\"summary\": string"
            "}\n\n"
            "Critical Instruction for the 'summary' key:\n"
            "Write a highly professional, narrative 'Match Explanation' (2-3 sentences). "
            "Connect the candidate's specific achievements and metrics (e.g., ROI, productivity boosts) "
            "directly to the target company's mission and the job's technical needs. "
            "Use this structure: '[Candidate Name]'s experience as a [Role] at [Company], where they [Achievement with metrics], "
            "directly aligns with [Target Company]'s need for [Requirement]...'. "
            "The tone should be impactful, sophisticated, and recruiter-grade. Do not use generic filler.\n\n"
