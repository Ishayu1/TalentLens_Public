...
try:
    ...
    # Fallback for when running from root and src/ui/ is not a package or shadowed
    import sys
...
MEMBER_CHUNKS_PATH = PROJECT_ROOT / "data" / "artifacts" / "member_chunks_metadata.json"
MEMBER_RESUMES_META_PATH = PROJECT_ROOT / "data" / "artifacts" / "member_resumes_metadata.json"
FAISS_INDEX_PATH = PROJECT_ROOT / "data" / "artifacts" / "resume_index.faiss"
